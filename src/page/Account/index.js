...
import { Input, Button, Card, message, Row, Col, Form } from 'antd';
      ...
      <div>
        <Card bordered={false}>
          <Form onSubmit={this.handleSubmit} form={form}>
            <Form.Item {...formItemLayout} label="当前手机号" name="currentPhoneNumber">
            ...
            {!this.state.configPhoneNumber
              ? [
                <Form.Item {...formItemLayout} label="原密码" key="oldPassWord" name="oldPassWord">
                ...
                <Form.Item {...formItemLayout} label="新密码" key="newPassWord" name="newPassWord">
                ...
                <Form.Item {...formItemLayout} label="确认密码" key="compareNewPassWord" name="compareNewPassWord">
              ...
              : [
                <Form.Item {...formItemLayout} label="登录密码" key="password" name="password">
                ...
                <Form.Item {...formItemLayout} label="新手机号" key="newPhoneNumber" name="newPhoneNumber">
...
export default Form.useForm()(RePassword);
